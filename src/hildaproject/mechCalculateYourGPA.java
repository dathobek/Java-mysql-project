...
public class mechCalculateYourGPA extends JFrame

{
	...
	private String[] prg={"Program","HC00 - Software Engineering","HC05 - System Management & Networking","HK01 - Civil Engineering",
  	...
  	private String[] sub={"Courses","GENERAL INORGANIC CHEMISTRY","EXPERIMENTAL PHYSICS I","GENERAL PHYSICS I","DATA ANALYSIS","GENERAL MATHEMATICS I","PHILOSOPHY, LOGIC & CONFLICT RESOLUTION","USE OF LIBRARY","COMMUNICATION IN ENGLISH I","PRACTICAL CHEMISTRY","GENERAL PHYSICAL CHEMISTRY","EXPERIMENTAL PHYSICS II","HEAT AND PROPERTIES OF MATTER","GENERAL PHYSICS II","VECTOR AND DYNAMICS","GENERAL MATHEMATICS II","COMMUNICATION IN ENGLISH II","AFRICAN CULTURE, CIVILIZATION & NIGERIAN PEOPLE","PRACTICAL CHEMISTRY","GENERAL ORGANIC CHEMISTRY","BASIC THERMODYNAMICS","FLUID MECHANICS I","ENGINEERING MATERIALS","BASIC MANUFACTURING TECHNOLOGY","ENGINEERING MECHANICS I","ENGINEERING DRAWING I","ENGINEERING LABORATORY I","MATHEMATICAL ANALYSIS","BASIC ELECTRICAL ENGINEERING I","COMPUTER PROGRAMMING","STRENGTH OF MATERIALS I","ENGINEERING MECHANICS II","BASIC WORKSHOP PRACTICE","ENGINEERING DRAWING II","ENGINEER IN SOCIETY","ENGINEERING LABORATORY II","INFORMATION TECHNOLOGY IN ENGINEERING","LINEAR ALGEBRA AND ANALYTICAL GEOMETRY","BASIC ELECTRICAL ENGINEERING II","BASIC CIVIL ENGINEERING","MECHANICAL ENGINEERING LABORATORY I","MECHANICS OF MACHINES I","THERMODYNAMICS & HEAT TRANSFER","FLUID MECHANICS II","MACHINE DRAWING","MANUFACTURING TECHNOLOGY I","STRENGTH OF MATERIALS II","DIFFERENTIAL EQUATIONS","ELECTRICAL MACHINES I","ENTREPRENEURIAL STUDIES","MECHANICAL ENGINEERING LABORATORY II","MECHANICAL SYSTEM INSTRUMENTATION","HEAT TRANSFER","MECHANICAL ENGINEERING DESIGN I","MACHANICS OF MACHINES II","MANUFACTURING TECHNOLOGY II","METALLURGY I","ENGINEERING ENTREPRENEURSHIP","TECHNICAL WRITING AND SEMINAR","PROBABILITY AND STATISTICS","OIL AND GAS INDUSTRY EQUIPMENT MAINTENANCE","INTRODUCTION TO PETROLEUM ENGINEERING","MECHANICAL ENGINEERING LABORATORY III","WORKSHOP PRACTICE (AUTO/R&A)","INTRODUCTION TO OIL AND GAS PRODUCTION FACILITIES I","PRINCIPLES OF AIRCONDITIONING & REFRIGERATION","MECHANICAL ENGINEERING DESIGN II","FIRE AND SAFTY ENGINEERING","METALLURGY II","NUMERICAL METHODS AND COMPUTER APPLICATIONS","TURBOMACHINERY","SIX MONTHS SIWES","MATHEMATICAL MODELING AND OPERATIONS RESEARCH","NUMERICAL CONTROL MACHINE TOOLS","COMPUTATIONAL TRANSPORT PHENOMENA","FORMING AND FINISHING TECHNOLOGY","TECHNOLOGY POLICY AND DEVELOPMENT","INTRODUCTION TO OIL AND GAS PRODUCTION FACILITIES II","INDUSTRIAL ENGINEERING","ADVANCED THERMODYNAMICS","FRACTURE AND FATIGUE OF ENGINEERING MATERIAL","MECHANICAL ENGINEERING DESIGN III","COMPUTER-AIDED DESIGN & MANUFACTURE","ROBOTICS: MECHANICS AND CONTROL","MECHATRONICS I","ENGINEERING LAW AND MANAGEMENT","QUALITY AND RELIABILITY ASSURANCE","MECHANICAL VIBRATIONS AND NOISE","POWER PLANT ENGINEERING","POWER PLANT ENGINEERING","ENGINEERING MATERIALS SELECTION","MECHATRONICS II","FINAL YEAR PROJECT AND SEMINAR","INDUSTRIAL AUTOMATION","ENGINEERING ECONOMICS","INDUSTRIAL VENTILATION AND AIR POLLUTION CONTROL SYSTEMS","PRODUCTION ENGINEERING","THEORY OF ELASTICITY AND PLASTICITY","AIR CONDITIONING AND REFRIGERATING ENGINEERING","CONTROL SYSTEMS ENGINEERING","CORROSION AND PROTECTION","STEEL MAKING TECHNOLOGY","BUILDING SERVICES ENGINEERING"};
